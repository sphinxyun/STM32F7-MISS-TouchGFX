...
extern GUI_CONST_STORAGE GUI_BITMAP bmadd_button;
...
*/
static GUI_CONST_STORAGE GUI_COLOR _Colorsadd_button[] = {
#if (GUI_USE_ARGB == 0)
...
static GUI_CONST_STORAGE GUI_LOGPALETTE _Paladd_button = {
  2,  // Number of entries
  0,  // No transparency
  &_Colorsadd_button[0]
};

static GUI_CONST_STORAGE unsigned char _acadd_button[] = {
...
GUI_CONST_STORAGE GUI_BITMAP bmadd_button = {
  64, // xSize
  64, // ySize
  8, // BytesPerLine
  1, // BitsPerPixel
  _acadd_button,  // Pointer to picture data (indices)
  &_Paladd_button   // Pointer to palette
};
